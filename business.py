...
class Business(Resource):
    ...
    def post(self):
        ...
        def check_type(sub_type, business_uid):
            print("In Check Type")
            with connect() as db:
                type_query = db.select(
                    "every_circle.types", where={"sub_type": sub_type}
                )
                ...
                print(type_uid)
                business_type_stored_procedure_response = db.call(
                    procedure="new_bt_uid"
                )
                ...
                business_type_insert_query = db.insert(
                    "every_circle.business_type", business_type_payload
                )
    ...
    def post(self):
        ...
        def check_category(category_uid, business_uid):
            ...
            with connect() as db:
                ...
                business_category_stored_procedure_response = db.call(
                    procedure="new_bc_uid"
                )
                bc_uid = business_category_stored_procedure_response["result"][0][
                    "new_id"
                ]
                ...
                business_category_insert_query = db.insert(
                    "every_circle.business_category", business_category_payload
                )
            ...
            with connect() as db:
                ...
                if not business_look_up_query["result"]:
                    ...
                    if "business_categories_uid" in payload:
                        ...
                        business_categories_uid = ast.literal_eval(
                            business_categories_uid
                        )
        ...
        try:
            with connect() as db:
                ...
                for business in businesses:
                    ...
                    business["tags"] = (
                        [row["tag_name"] for row in tags_result["result"]]
