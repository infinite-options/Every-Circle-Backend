...
def _anonymize_profile_tombstone(db, profile_uid, deleted_at):
    db.execute(
        ...
        SET profile_personal_user_id = NULL,
            ...
            profile_personal_email_audience = NULL,
            profile_personal_phone_number = NULL,
            profile_personal_phone_number_audience = NULL,
            profile_personal_city = NULL,
            profile_personal_city_audience = NULL,
            profile_personal_state = NULL,
            profile_personal_state_audience = NULL,
            ...
            profile_personal_image_audience = NULL,
            profile_personal_tag_line = NULL,
            profile_personal_tag_line_audience = NULL,
            profile_personal_short_bio = NULL,
            profile_personal_short_bio_audience = NULL,
            profile_personal_resume = NULL,
            profile_personal_resume_audience = NULL,
            ...
            profile_personal_experience_audience = NULL,
            profile_personal_education_audience = NULL,
            profile_personal_expertise_audience = NULL,
            profile_personal_wishes_audience = NULL,
            profile_personal_business_audience = NULL,
            profile_personal_social_audience = NULL,
