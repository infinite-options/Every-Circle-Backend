...
class Ratings(Resource):
    def get(self, uid):
        ...
        try:
            ...
            # Record profile view in DB if viewer_uid provided and not a self-view
            if viewer_uid and viewer_uid != uid:
                ...
                with connect() as db_v:
                    ...
                    if existing:
                        ...
                        print(f"Updated view {existing_uid} for {viewer_uid} -> {uid}")
                    else:
                        ...
                        if new_uid:
                            ...
                            print(
                                f"Inserted new view {new_uid} for {viewer_uid} -> {uid}"
                            )
