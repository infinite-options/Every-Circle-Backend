...
def build_expertise_snapshot(row):
    ...
    snapshot = {
        ...
        "shipping": row.get("profile_expertise_shipping"),
        "shippingAmount": _serialize_value(row.get("profile_expertise_shipping_amount")),
        "shippingRefundable": row.get("profile_expertise_shipping_refundable"),
        ...
        "zip": row.get("profile_expertise_zip"),
...
def build_wish_snapshot(row):
    ...
    snapshot = {
        ...
        "shipping": row.get("profile_wish_shipping"),
        "shippingAmount": _serialize_value(row.get("profile_wish_shipping_amount")),
        "shippingRefundable": row.get("profile_wish_shipping_refundable"),
...
def build_user_snapshot(row):
    ...
    snapshot = {
        ...
        "emailAudience": row.get("profile_personal_email_audience"),
        "phoneNumber": row.get("profile_personal_phone_number"),
        "phoneNumberAudience": row.get("profile_personal_phone_number_audience"),
        "city": row.get("profile_personal_city"),
        "state": row.get("profile_personal_state"),
        "country": row.get("profile_personal_country"),
        "cityAudience": row.get("profile_personal_city_audience"),
        "stateAudience": row.get("profile_personal_state_audience"),
        ...
        "imageAudience": row.get("profile_personal_image_audience"),
        "tagLine": row.get("profile_personal_tag_line"),
        "tagLineAudience": row.get("profile_personal_tag_line_audience"),
        "shortBio": row.get("profile_personal_short_bio"),
        "shortBioAudience": row.get("profile_personal_short_bio_audience"),
        "resume": row.get("profile_personal_resume"),
        "resumeAudience": row.get("profile_personal_resume_audience"),
    }
    return {k: v for k, v in snapshot.items() if v is not None}
