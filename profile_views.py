            ...
            with connect() as db:
                ...
                query = """
                    SELECT
                        ...
                        pp.profile_personal_image_audience   AS viewer_image_audience,
                        pp.profile_personal_tag_line         AS viewer_tag_line,
                        pp.profile_personal_tag_line_audience AS viewer_tag_line_audience,
                        pp.profile_personal_phone_number     AS viewer_phone,
                        pp.profile_personal_phone_number_audience AS viewer_phone_audience,
                        pp.profile_personal_city             AS viewer_city,
                        pp.profile_personal_state            AS viewer_state,
                        pp.profile_personal_city_audience    AS viewer_city_audience,
                        pp.profile_personal_state_audience   AS viewer_state_audience,
                        pp.profile_personal_email_audience   AS viewer_email_audience,
